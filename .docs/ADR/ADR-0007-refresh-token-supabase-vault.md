...
- **Status:** Proposed — awaiting USER confirmation. The USER said "the token will be stored in Supabase env vars"; this ADR reads that as Supabase **Vault** (reasons below).
...
- One more migration (functions + grants) after this ADR is accepted.
